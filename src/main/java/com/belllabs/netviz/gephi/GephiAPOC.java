package main.java.com.belllabs.netviz.gephi;
...
/**
 * 
 * APOC package class imported to this project: Source can be found at https://raw.githubusercontent.com/neo4j-contrib/neo4j-apoc-procedures/3.2/src/main/java/apoc/gephi/Gephi.java
 * @author mh
 * @since 29.05.16
 */
...
public class GephiAPOC {
    ...
    public Stream<ProgressInfo> add(@Name("urlOrKey") String keyOrUrl, @Name("workspace") String workspace, @Name("data") Object data,@Name(value = "weightproperty",defaultValue = "null") String weightproperty,@Name(value = "exportproperties",defaultValue = "[]") List<String> exportproperties) {
        ...
        if (Graphs.extract(data, nodes, rels)) {
            ...
            ((Stream<ProgressInfo>) JsonUtil.loadJson(url,map("method","POST"), payload)).count();
